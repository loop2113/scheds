            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Rooms <button type="button" class="btn btn-primary btns" data-bs-toggle="modal" data-bs-target="#addRoom">+ Add Room</button></h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='schedules.php?room_id=<?php echo $row['id']?>' class="btn btn-success btn-sm"><i class="fa-solid fa-plus"></i></a>
