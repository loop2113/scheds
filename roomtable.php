            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Rooms Timetables<button type="button" class="btn btn-primary btns" data-bs-toggle="modal" data-bs-target="#addRoom">+ Add Room Schedule</button></h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='roomutil_timetables.php?addid=<?php echo $row['id']?>' class="btn btn-success btn-sm"><i class="fa-solid fa-plus"></i></a>
                                                <a href='?deleteeid=<?php echo $row['id']?>' class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" id="ha" method="POST">
                            <div class="mb-3">
                                <label for="faculty">Room Name:</label>
...
if(isset($_POST['save'])){
      ...
      $query = "INSERT INTO rooms (room, description) VALUES ('$room', '$description')";
...
if (isset($_GET["deleteeid"])) {
    ...
    $deleteSql = "DELETE FROM rooms WHERE rooms.id = $deleteEid";
