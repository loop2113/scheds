...
// Additional conditions for the SQL query based on selected section and room
$sectionCondition = '';
if ($selectedSection) {
    $sectionCondition = " AND sections.section = '$selectedSection'";
}
...
<div class="container">
        ...
        <div class="col-sm text-left">
            <div class=""><b>Class:</b> <?= strtoupper($sectionName) ?> </div>
        </div>
        <div class="col-sm text-left">
            <div class=""><b>A.Y.</b> <?=  $currentYear; ?> - <?= $nextYear; ?></div>
        </div>
        <div class="col-sm text-left">
            <div class=""><b>Semester:</b> <?= $selectedSemester; ?></div>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-sm text-left">
            <div class="mb-2"><b>Adviser:</b> <?= strtoupper($selectedFaculty) ?> </div>
        </div>
        <div class="col-sm text-left">
            <div><b>Bldg:</b> <?= strtoupper($selectedBuilding); ?></div>
        </div>
        <div class="col-sm text-left">
            <div></div>
        </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-sm text-left">
            <div><b>Room No.</b> <?= strtoupper($selectedRoom); ?></div>
        </div>
        <div class="col-sm text-left">
                    ...
                    foreach ($timeSlots as $timeSlot) {
                        ...
                        for ($day = 0; $day < 7; $day++) {  
                            ...
                            foreach ($schedulesForSlot as $schedule) {
                                echo "<div class='schedule-cell'>" . $schedule['room'] . '<br>'. $schedule['subject']  .'<br><b>' .$schedule['name'] .'</b><br>'. $schedule['starttime'] . ' to ' . $schedule['endtime'] . "</div>";
                            }
